...
namespace ANH.Database
{
    ...
    /// </summary>
    public interface IBaseListDataStore
    {
        /// <summary>
        ...
        Task<List<EquipmentDataModel>> GetEquipmentListsAsync();

        Task<EquipmentDataModel> GetEquipmentListItemsAsync(string name);
        ...
        Task SaveBaseListsAsync(EquipmentDataModel baseLists);
