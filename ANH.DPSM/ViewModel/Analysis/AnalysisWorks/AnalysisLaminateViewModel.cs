...
namespace ANH.DPSM
{
    ...
    public class AnalysisLaminateViewModel : BaseViewModel
    {
        ...
        public void Create()
        {
            //ViewModelEquipmentManagement.CurrentAction = AnalysisAction.Create;
        ...
        public void Modify()
        {
            //ViewModelEquipmentManagement.CurrentAction = AnalysisAction.Modify;
        ...
        public void Import()
        {
            //ViewModelEquipmentManagement.CurrentAction = AnalysisAction.Import;
            IconCreate.IsSelect = false;
            IconModify.IsSelect = false;
        ...
        public void Delete()
        {
            //ViewModelEquipmentManagement.CurrentAction = AnalysisAction.Delete;
            IconCreate.IsSelect = false;
            IconModify.IsSelect = false;
            IconImport.IsSelect = false;
