...
namespace ANH.DPSM
{
    ...
    /// </summary>
    public class EquipmentManagementViewModel : BaseViewModel
    {
        ...
        /// <summary>
        /// True if the Equipment management menu should be shown
        /// </summary>
        private bool mEquipmentManagementMenuVisible;
        ...
        /// <summary>
        /// True if the Equipment settings menu should be shown
        /// </summary>
        public bool EquipmentManagementVisible
        {
            get => mEquipmentManagementMenuVisible;
            set
            {
                // If property has not changed...
                if (mEquipmentManagementMenuVisible == value)
                    // Ignore
                    return;

                // Set the backing field
                mEquipmentManagementMenuVisible = value;
        ...
        {
            // Close settings menu
            ViewModelEquipmentManagement.EquipmentManagementVisible = true;
        }
        ...
        {
            // Close settings menu
            ViewModelEquipmentManagement.EquipmentManagementVisible = false;
        }
