...
namespace ANH.Core
{
    ...
    public static class IoC
    {
        ...
        /// </summary>
        public static AnalysisViewModel Analysis => IoC.Get<AnalysisViewModel>();
        ...
        private static void BindViewModels()
        {
            ...
            // Bind to a single instance of Analysis view model
            Kernel.Bind<AnalysisViewModel>().ToConstant(new AnalysisViewModel());
        }
