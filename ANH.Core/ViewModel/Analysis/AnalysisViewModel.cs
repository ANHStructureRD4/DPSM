...
namespace ANH.Core
{
    ...
    public class AnalysisViewModel :BaseViewModel
    {
        ...
        public BaseViewModel SetCurrentViewModel()
        {
            ...
            if (CurrentContent == AnalysisContent.Unit)
            {
                return new AnalysisUnitViewModel()
                {
                    ...
                    IsEdited = (IoC.Analysis.CurrentAction == AnalysisAction.Create) ? true : false
                };
            }
        ...
        public void OpenAnalysis()
        {
            ...
            IoC.Application.AnalysisWideMenuVisible ^= true;
        }
        ...
        {
            // Open Analysis module
            IoC.Application.LibraryWideMenuVisible ^= true;
        }
        ...
        public void OpenContentsList(AnalysisViewModel parameter)
        {
            ...
            IoC.Application.GoToPage(ApplicationPage.Analysis, analysisviewmodel);
        ...
        public void OpenLibraryData(AnalysisViewModel parameter)
        {
            ...
            IoC.Application.LibraryWideMenuVisible = parameter.LibrarySpaceVisible;
            IoC.Application.AnalysisWideMenuVisible = parameter.AnalysisSubListVisible;

            var analysisviewmodel = parameter;

            // Get analysis contents list and data
            IoC.Application.GoToLibrary(ApplicationPage.Library, analysisviewmodel);
