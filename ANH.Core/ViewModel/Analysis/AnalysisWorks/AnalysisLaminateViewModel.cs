...
namespace ANH.Core
{
    ...
    public class AnalysisLaminateViewModel : BaseViewModel
    {
        ...
        public void Create()
        {
            IoC.Analysis.CurrentAction = AnalysisAction.Create;
        ...
        public void Modify()
        {
            IoC.Analysis.CurrentAction = AnalysisAction.Modify;
        ...
        public void Import()
        {
            IoC.Analysis.CurrentAction = AnalysisAction.Import;
            IconCreate.IsSelect = false;
            IconModify.IsSelect = false;
        ...
        public void Delete()
        {
            IoC.Analysis.CurrentAction = AnalysisAction.Delete;
            IconCreate.IsSelect = false;
            IconModify.IsSelect = false;
            IconImport.IsSelect = false;
